  ...
  return (
    <section id="distribuidor" className="section bg-light-gray scroll-m-16">
      <div className="container text-center">
        ...
        <Link href="https://wa.me/+541134943796" className="group w-fit mx-auto bg-[#1D2F4E] text-white py-2 px-4 rounded text-sm font-medium hover:bg-[#1D2F4E]/90 transition flex items-center justify-center">
